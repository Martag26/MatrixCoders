...
<aside class="crm-sidebar" id="crmSidebar">
  ...
  <nav class="crm-sidebar__nav">
    ...
    <div class="crm-sidebar__section">
      ...
      <a href="<?= $crmBase ?>perfil"
         class="crm-sidebar__link <?= $seccion==='perfil'?'active':'' ?>"
         data-tooltip="Mi perfil">
        <svg class="crm-sl-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5.121 17.804A8 8 0 0112 15a8 8 0 016.879 2.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        <span class="crm-sl-label">Mi perfil</span>
      </a>

      <a href="<?= $crmBase ?>ajustes"
         class="crm-sidebar__link <?= $seccion==='ajustes'?'active':'' ?>"
        ...
        <span class="crm-sl-label">Ajustes</span>
      </a>
    </div>
  ...
  <div class="crm-sidebar__footer">
    <a href="<?= $crmSiteUrl ?>" class="crm-sidebar__link" data-tooltip="Volver al sitio">
      <svg class="crm-sl-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
      <span class="crm-sl-label">Volver al sitio</span>
    </a>
  </div>
  ...
  <header class="crm-header">
    ...
    <div class="crm-header__right">
      ...
      <div class="crm-header-search">
        ...
        <input type="text" placeholder="Buscar en CRM..." id="headerSearch" autocomplete="off">
      </div>
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" style="min-width:200px;border-radius:12px;border:1px solid var(--crm-border);box-shadow:var(--crm-shadow-md);padding:6px;">
          ...
          <li><a class="dropdown-item" style="font-size:13px;border-radius:7px;" href="<?= $crmBase ?>perfil">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="margin-right:7px"><path stroke-linecap="round" d="M5.121 17.804A8 8 0 0112 15a8 8 0 016.879 2.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>Mi perfil</a></li>
          <li><a class="dropdown-item" style="font-size:13px;border-radius:7px;" href="<?= $crmBase ?>ajustes">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="margin-right:7px"><path stroke-linecap="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>Ajustes</a></li>
          <li><hr class="dropdown-divider" style="margin:4px 0;"></li>
