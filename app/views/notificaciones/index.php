...
$tiposConfig = [
    ...
    'examen_teorico'     => ['label'=>'Examen',          'color'=>'#0891b2','bg'=>'#ecfeff','border'=>'#a5f3fc','icon'=>'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
    'examen_practico'    => ['label'=>'Práctico',        'color'=>'#0d9488','bg'=>'#f0fdfa','border'=>'#99f6e4','icon'=>'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4'],
    'revision_pendiente' => ['label'=>'Revisión',        'color'=>'#9333ea','bg'=>'#faf5ff','border'=>'#e9d5ff','icon'=>'M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z'],
    'nueva_matricula'    => ['label'=>'Matrícula',       'color'=>'#16a34a','bg'=>'#f0fdf4','border'=>'#bbf7d0','icon'=>'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z'],
